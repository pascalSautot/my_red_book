...
BEGIN_APP_DECLARATION(InstancingExample)
    enum { vPosition=0, vNormIndex=1, vTexture=2, vColor=3 };
...
void InstancingExample::Initialize(const char * title)
{
   ...
   // "model_matrix" is actually an array of 4 matrices
    ...
    object.LoadFromVBM("media/armadillo_low.vbm", vPosition, vNormIndex, vTexture);
...
void InstancingExample::Display(bool auto_redraw)
{
    ...
    for (n = 0; n < 4; n++)
    {
        ...
        model_matrix[n] = (vmath::scale(5.0f) *
                           ...
                           vmath::translate((float)n * 10.0f - 15.0f, n*10.0f, n/2*10.0f) *
                           vmath::scale(0.01f));
                           */
        model_matrix[n] = (vmath::scale(5.0f) *
