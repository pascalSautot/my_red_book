...
uniform Lights {
    ...
    vec4 ambiantColor;
    vec4 pointlightSourceColor;
    vec4 pointLightSourcePosition;
    vec4 farLightSourceColor;
    vec3 farLightSourceDirection; 
    vec4 spotLightSourceColor;
    vec3 spotLightSourceDirection;     
};
